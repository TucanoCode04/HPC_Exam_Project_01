...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{../Giro_part/Esercizio_2/Grafici/Grafico_tempi_variandoM_conIO.png}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.6\textwidth]{../Giro_part/Esercizio_2/Grafici/combo_bars_lines_1socket.png}
...
\begin{figure}[htbp]
    ...
    \includegraphics[width=0.6\textwidth]{../Giro_part/Esercizio_2/Grafici/combo_bars_lines_2socket.png}
