...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\textwidth]{../src/Davide/Final/Latex/figures/size_sweep_execution_time.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\textwidth]{../src/Davide/Final/Latex/figures/size_sweep_phase_breakdown.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\textwidth]{../src/Davide/Final/Latex/figures/nsys_os_runtime_breakdown.png}
...
of threads already saturates available memory bandwidth. It is also
consistent with a second, unruled-out explanation: \texttt{compute\_next}
forks a fresh OpenMP thread team on every one of the 300 calls/rank
(Section~\ref{sec:metrics}'s sweep confirms \texttt{compute\_next} itself
is only $\sim$2.4\% of wall-clock time), so fork/join and barrier
overhead alone could plateau this curve independently of memory
bandwidth; we did not isolate which of the two dominates. This contrasts
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\textwidth]{../src/Davide/Final/Latex/figures/thread_sweep_speedup_efficiency.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.65\textwidth]{../src/Davide/Final/Latex/figures/blocksize_sweep_kernel_time.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\textwidth]{../src/Davide/Final/Latex/figures/contention_sweep_solo_vs_shared.png}
