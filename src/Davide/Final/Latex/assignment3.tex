...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.56\textwidth]{../src/Davide/Final/Latex/figures/size_sweep_execution_time.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.56\textwidth]{../src/Davide/Final/Latex/figures/size_sweep_phase_breakdown.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.36\textwidth]{../src/Davide/Final/Latex/figures/nsys_os_runtime_breakdown.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.56\textwidth]{../src/Davide/Final/Latex/figures/thread_sweep_speedup_efficiency.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.36\textwidth]{../src/Davide/Final/Latex/figures/blocksize_sweep_kernel_time.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.42\textwidth]{../src/Davide/Final/Latex/figures/contention_sweep_solo_vs_shared.png}
