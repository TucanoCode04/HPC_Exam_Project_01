...
under 0.3\% \footnote{See output\_1920920.txt}. The Threading analysis, however,
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.55\textwidth]{../assignment_1/plots/timeandCPUU96.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.62\textwidth]{../assignment_1/plots/scaling.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.62\textwidth]{../assignment_1/plots/scaling_noio.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.62\textwidth]{../assignment_1/plots/scaling_noio_static.png}
