...
Access). Under the default \textit{first-touch} policy, a physical page
...
outperforms \texttt{schedule(static)} in practice \cite{guidedandstatic}: dynamic work
...
for the final implementation. As shown later in the testing section,
